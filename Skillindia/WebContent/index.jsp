...
<nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Registration <span
                            class="caret"></span></a>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img src="C:\Users\vshadmin\Desktop\NATS\web\HTML\cover1.jpg" alt="Los Angeles" style="width:100%; ">
            </div>

            <div class="item">
                <img src="C:\Users\vshadmin\Desktop\NATS\web\HTML\cover2.jpg0" alt="Chicago" style="width:100%;">
            </div>
